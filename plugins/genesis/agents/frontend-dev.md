...
2. Already in this codebase? Check first — `node <plugin root>/hooks/graph-query.js where <name>` / `callers <name>` before writing a component/helper that might duplicate one.
